...
|------------------|--------------------------------------|---------|
| `dtreat prompts` | `stages/prompt_collection`           | §4.1, Eq 1–3 |
| `dtreat hypotheses` | `stages/hypothesis_generation`    | §4.2    |
| `dtreat responses`  | `stages/response_collection`      | §4.3, Eq 4 |
| `dtreat score`      | `stages/response_scoring`         | §4.4, Eq 5–7 |
| `dtreat analyze`    | `stages/treatment_analysis`       | §4.5, Eq 9–14 |
...
1. Every structured record is a `SchemaBase` dataclass (`common/schema_base.py`)
