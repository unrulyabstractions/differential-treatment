...
1. FLAT IMPORTS - Import classes/functions directly from package:
   ...
   from dtreat.common import SimpleBinaryChoice, normalize
   from dtreat.common.math import normalize, argmax

   This works because __init__.py explicitly re-exports from subpackages.

2. SUBPACKAGE IMPORTS - Import subpackages as modules:

   from dtreat.common import math
   math.normalize(...)
...
3. EXPLICIT MODULE IMPORTS - Still work as normal:
   ...
   from dtreat.common.choice.simple_binary_choice import SimpleBinaryChoice
   from dtreat.common.math.math_primitives import normalize
...
Just add these two lines to any package's __init__.py:
    ...
    from dtreat.common.auto_export import auto_export
